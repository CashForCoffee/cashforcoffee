...
function summaryCards(p){const s=periodStats(p);return `<section class="summary">
  ...
  <div class="summary-card remaining"><div class="summary-label">${icon('wallet')} Remaining outgoings</div><div class="summary-value mono">${money(s.remainingOutgoings)}</div><div class="summary-note">Still to leave the main account</div></div>
